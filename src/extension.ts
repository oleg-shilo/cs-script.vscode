...
export function activate(context: vscode.ExtensionContext) {
    ...
    try {
        ...
        // --
        context.subscriptions.push(vscode.languages.registerCodeActionsProvider('csharp', new CSScriptCodeActionProvider()));                               // e.g. "add usings"
        context.subscriptions.push(vscode.languages.registerSignatureHelpProvider('csharp', new CSScriptSignatureHelpProvider(), '(', ','));                // hint the signature while typing
        ...
        context.subscriptions.push(vscode.commands.registerCommand('cs-script.reset_busy', cs_script.reset_busy));
        context.subscriptions.push(vscode.commands.registerCommand('cs-script.integrate', cs_script.redeploy));
